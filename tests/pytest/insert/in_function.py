...
class TDTestCase:
    ...
    def run(self):
        ...
        cmd13 = 'create table in_binary_nchar_2 using in_stable_3 tags(\'DThouse\',\'北京涛思数据科技有限公司\') ; '
        cmd14 = 'create table in_binary_nchar_3 using in_stable_3 tags(\'taosdataDThouse\',\'北京涛思数据科技有限公司DThouse\') ; '
        tdLog.info(cmd1)
        tdSql.execute(cmd1)
        tdLog.info(cmd2)
        tdSql.execute(cmd2)
        ...
        tdSql.checkData(0,3,'DThouse') 
        tdSql.checkData(0,4,'北京涛思数据科技有限公司')      
        tdSql.query('select * from in_stable_3 where tin_binary in (\'DThouse\') order by ts desc')
        tdSql.checkData(0,1,'TAOS') 
        tdSql.checkData(0,2,'涛思数据TAOSdata')
        tdSql.checkData(0,3,'DThouse') 
        tdSql.checkData(0,4,'北京涛思数据科技有限公司')  
        ...
        cmd3 = 'insert into in_binary_nchar_3 values(now,\'DThouse\',\'北京涛思数据科技有限公司\') ;'
        tdLog.info(cmd3)
        tdSql.execute(cmd3)         
        tdSql.query('select * from in_stable_3 where in_binary in (\'DThouse\') order by ts desc')
        tdSql.checkData(0,1,'DThouse') 
        tdSql.checkData(0,2,'北京涛思数据科技有限公司')
        tdSql.checkData(0,3,'taosdataDThouse') 
        tdSql.checkData(0,4,'北京涛思数据科技有限公司DThouse')  
        tdSql.query('select * from in_stable_3 where in_nchar in (\'北京涛思数据科技有限公司\') order by ts desc')
        tdSql.checkData(0,1,'DThouse') 
        tdSql.checkData(0,2,'北京涛思数据科技有限公司')
        tdSql.checkData(0,3,'taosdataDThouse') 
        tdSql.checkData(0,4,'北京涛思数据科技有限公司DThouse')     
        tdSql.query('select * from in_stable_3 where tin_binary in (\'taosdataDThouse\') order by ts desc')
        tdSql.checkData(0,1,'DThouse') 
        tdSql.checkData(0,2,'北京涛思数据科技有限公司')
        tdSql.checkData(0,3,'taosdataDThouse') 
        tdSql.checkData(0,4,'北京涛思数据科技有限公司DThouse')   
        tdSql.query('select * from in_stable_3 where tin_nchar in (\'北京涛思数据科技有限公司DThouse\') order by ts desc')
        tdSql.checkData(0,1,'DThouse') 
        tdSql.checkData(0,2,'北京涛思数据科技有限公司')
        tdSql.checkData(0,3,'taosdataDThouse') 
        tdSql.checkData(0,4,'北京涛思数据科技有限公司DThouse') 
        tdSql.query('select * from in_binary_nchar_3 where in_binary in (\'DThouse\') order by ts desc')
        tdSql.checkData(0,1,'DThouse') 
        tdSql.checkData(0,2,'北京涛思数据科技有限公司') 
        ...
        cmd1 = '''select * from in_stable_3 
                where in_binary in (\'0\',\'DThouse\',\'TAOS\') 
                and in_nchar in (\'0\',\'北京涛思数据科技有限公司\',\'涛思数据TAOSdata\')
                and tin_binary in (\'0\',\'DThouse\',\'taosdataDThouse\') 
                and tin_nchar in (\'0\',\'北京涛思数据科技有限公司\',\'北京涛思数据科技有限公司DThouse\')
                order by ts desc ;'''
        tdLog.info(cmd1)        
        tdSql.query(cmd1)
        tdSql.checkData(0,1,'DThouse') 
        ...
        cmd3 = 'insert into normal_in_binary_nchar_1 values(now,\'DThouse\',\'北京涛思数据科技有限公司\') ;'
        tdLog.info(cmd3)
        tdSql.execute(cmd3)         
        tdSql.query('select * from normal_in_binary_nchar_1 where in_binary in (\'DThouse\') order by ts desc')
        tdSql.checkData(0,1,'DThouse') 
        tdSql.checkData(0,2,'北京涛思数据科技有限公司')         
