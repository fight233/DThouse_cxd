...
class TDTestCase:
    def caseDescription(self):
        '''
        case1:<wenzhouwww>: [TD-11945] this test case is an issue about taoshell and taosd crash , it now has been repaired on branch https://github.com/taosdata/DThouse/tree/feature%2FTD-6140
