...
::cmake\install.inc
%sed% -i "s/C:\/DThouse/C:\/jh_iot/g" %community_dir%\cmake\install.inc
...
%sed% -i "s/DThouse/jh_iot/g"  %community_dir%\src\dnode\src\dnodeSystem.c
::src\dnode\src\dnodeMain.c
%sed% -i "s/DThouse/jh_iot/g"   %community_dir%\src\dnode\src\dnodeMain.c
...
%sed% -i "s/DThouse shell/jh_iot shell/g" %community_dir%\src\kit\shell\src\shellDarwin.c
...
%sed% -i "s/DThouse shell/jh_iot shell/g" %community_dir%\src\kit\shell\src\shellLinux.c
...
%sed% -i "s/DThouse/jh_iot/g" %community_dir%\src\os\src\windows\wEnv.c
::src\kit\shell\src\shellEngine.c
%sed% -i "s/DThouse shell/jh_iot shell/g" %community_dir%\src\kit\shell\src\shellEngine.c
