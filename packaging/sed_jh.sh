...
function replace_community_jh() {
  # cmake/install.inc
  sed -i "s/C:\/DThouse/C:\/jh_iot/g" ${top_dir}/cmake/install.inc
  ...
  sed -i "s/DThouse/jh_taos/g" ${top_dir}/src/dnode/src/dnodeSystem.c
  sed -i "s/DThouse/jh_taos/g" ${top_dir}/src/dnode/src/dnodeMain.c
  ...
  sed -i "s/DThouse shell/jh_iot shell/g" ${top_dir}/src/kit/shell/src/shellDarwin.c
  ...
  sed -i "s/DThouse shell/jh_iot shell/g" ${top_dir}/src/kit/shell/src/shellLinux.c
  sed -i "s/2020 by TAOS Data/2021 by Jinheng Technology/g" ${top_dir}/src/kit/shell/src/shellLinux.c
  # src/os/src/windows/wEnv.c
  sed -i "s/C:\/DThouse/C:\/jh_iot/g" ${top_dir}/src/os/src/windows/wEnv.c
  # src/kit/shell/src/shellEngine.c
  sed -i "s/DThouse shell/jh_iot shell/g" ${top_dir}/src/kit/shell/src/shellEngine.c
  ...
  sed -i "s/productName=\"DThouse\"/productName=\"jh_iot\"/g" ${top_dir}/packaging/tools/makepkg.sh
  ...
  sed -i "s/productName=\"DThouse\"/productName=\"jh_iot\"/g" ${top_dir}/packaging/tools/remove.sh
  ...
  sed -i "s/productName=\"DThouse\"/productName=\"jh_iot\"/g" ${top_dir}/packaging/tools/install.sh
  ...
  sed -i "s/productName=\"DThouse\"/productName=\"jh_iot\"/g" ${top_dir}/packaging/tools/makeclient.sh
  ...
  sed -i "s/productName=\"DThouse\"/productName=\"jh_iot\"/g" ${top_dir}/packaging/tools/install_client.sh
  ...
  sed -i "s/productName=\"DThouse\"/productName=\"jh_iot\"/g" ${top_dir}/packaging/tools/makearbi.sh
  # packaging/tools/remove_arbi.sh
  sed -i "s/DThouse/jh_iot/g" ${top_dir}/packaging/tools/remove_arbi.sh
  # packaging/tools/install_arbi.sh
  sed -i "s/DThouse/jh_iot/g" ${top_dir}/packaging/tools/install_arbi.sh
  ...
  sed -i "s/productName=\"DThouse\"/productName=\"jh_iot\"/g" ${top_dir}/packaging/tools/make_install.sh
  ...
  # packaging/rpm/taosd
  sed -i "s/DThouse/jh_iot/g" ${top_dir}/packaging/rpm/taosd
  ...
  # packaging/deb/taosd
  sed -i "s/DThouse/jh_iot/g" ${top_dir}/packaging/deb/taosd
...
function replace_enterprise_jh() {
  ...
  sed -i "s/DThouse/jh_iot/g" ${top_dir}/../enterprise/src/kit/perfMonitor/perfMonitor.c
  ...
  sed -i "s/DThouse/jh_iot/g" ${top_dir}/../enterprise/src/plugins/web/admin/*.html
  # enterprise/src/plugins/web/admin/js/*.js
  sed -i "s/DThouse/jh_iot/g" ${top_dir}/../enterprise/src/plugins/web/admin/js/*.js
}
