...
::cmake\install.inc
%sed% -i "s/C:\/DThouse/C:\/KingHistorian/g" %community_dir%\cmake\install.inc
...
%sed% -i "s/DThouse/KingHistorian/g"  %community_dir%\src\dnode\src\dnodeSystem.c
::src\dnode\src\dnodeMain.c
%sed% -i "s/DThouse/KingHistorian/g"   %community_dir%\src\dnode\src\dnodeMain.c
...
%sed% -i "s/DThouse shell/KingHistorian shell/g" %community_dir%\src\kit\shell\src\shellDarwin.c
...
%sed% -i "s/DThouse shell/KingHistorian shell/g" %community_dir%\src\kit\shell\src\shellLinux.c
%sed% -i "s/2020 by TAOS Data/2021 by Wellintech/g" %community_dir%\src\kit\shell\src\shellLinux.c
::src\os\src\windows\wEnv.c
%sed% -i "s/DThouse/KingHistorian/g" %community_dir%\src\os\src\windows\wEnv.c
::src\kit\shell\src\shellEngine.c
%sed% -i "s/DThouse shell/KingHistorian shell/g" %community_dir%\src\kit\shell\src\shellEngine.c
