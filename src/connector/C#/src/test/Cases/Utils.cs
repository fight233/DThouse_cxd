...
namespace Test.UtilsTools
{
    public class UtilsTools
    {
        ...
        public static void DisplayRes(IntPtr res)
        {
            ...
            {
                queryRows++;
                IntPtr colLengthPtr = DThouse.FetchLengths(res);
                ...
                for (int fields = 0; fields < fieldCount; ++fields)
                {
                    ...
                    switch ((DThouseDataType)meta.type)
                    {
                        ...
                        case DThouseDataType.TSDB_DATA_TYPE_NCHAR:
                            ...
                            builder.Append(v10);
                            break;
                        case DThouseDataType.TSDB_DATA_TYPE_JSONTAG:
            ...
            DThouse.FreeResult(res); Console.WriteLine("");
        }
        ...
        public static List<DThouseMeta> getField(IntPtr res)
        {
            List<DThouseMeta> metas = DThouse.FetchFields(res);
            return metas;
        }
