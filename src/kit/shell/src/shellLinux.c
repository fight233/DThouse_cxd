...
static struct argp_option options[] = {
  {"host",       'h', "HOST",       0,                   "DThouse server FQDN to connect. The default host is localhost."},
...
char      LINUXCLIENT_VERSION[] = "Welcome to the DThouse shell from %s, Client Version:%s\n"
